...
```{r}
drops <- process_data_lab("twitch.lab")
twitch.lab.dtrain
twitch.lab.dtest

process_data_res("twitch.res")
twitch.res.dtrain
twitch.res.dtest
```
...
twitch.lab.C45Model <- train(isTarget ~., method="J48", data=twitch.lab.dtrain,
                tuneLength = 5,
                trControl = train_control)

twitch.res.C45Model <- train(isTarget ~., method="J48", data=twitch.res.dtrain,
                tuneLength = 5,
                trControl = train_control)
```


## Validation - twitch - C45 - Lab
```{r}
twitch.lab.C45Model$finalModel

print("lab")
predictions.lab.lab = predict(twitch.lab.C45Model, newdata = twitch.lab.dtest)
confMatrixes.lab.lab <- confusionMatrix(predictions.lab.lab, twitch.lab.dtest$isTarget)
eva.twitch.c45.lab.lab <- confMatrixes.lab.lab$byClass
eva.twitch.c45.lab.lab
confMatrixes.lab.lab$overall

print("res")
predictions.lab.res = predict(twitch.lab.C45Model, newdata = twitch.res.dtest)
confMatrixes.lab.res <- confusionMatrix(predictions.lab.res, twitch.res.dtest$isTarget)
...
## Validation - twitch - C45 - res
```{r}
twitch.res.C45Model$finalModel

print("lab")
predictions.res.lab = predict(twitch.res.C45Model, newdata = twitch.lab.dtest)
confMatrixes.res.lab <- confusionMatrix(predictions.res.lab, twitch.lab.dtest$isTarget)
...
confMatrixes.res.res <- confusionMatrix(predictions.res.res, twitch.res.dtest$isTarget)
...
twitch.lab.classifier_RF = randomForest(x = twitch.lab.dtrain[-74],
                             y = twitch.lab.dtrain$isTarget,
                             ntree = 500,
                             trControl = repeat_cv)

twitch.res.classifier_RF = randomForest(x = twitch.res.dtrain[-74],
                             y = twitch.res.dtrain$isTarget,
                             ntree = 500,
                             trControl = repeat_cv)
...
confMatrixes.lab.lab.rf <- confusionMatrix(predictions.lab.lab.rf, twitch.lab.dtest$isTarget)
eva.twitch.lab.lab.rf <- confMatrixes.lab.lab.rf$byClass
eva.twitch.lab.lab.rf
confMatrixes.lab.lab.rf$overall

print("res")
predictions.lab.res.rf = predict(twitch.lab.classifier_RF, newdata = twitch.res.dtest)
confMatrixes.lab.res.rf <- confusionMatrix(predictions.lab.res.rf, twitch.res.dtest$isTarget)
eva.twitch.lab.res.rf <- confMatrixes.lab.res.rf$byClass
eva.twitch.lab.res.rf
...
```{r}
print("lab")
predictions.res.lab.rf = predict(twitch.res.classifier_RF, newdata = twitch.lab.dtest)
confMatrixes.res.lab.rf <- confusionMatrix(predictions.res.lab.rf, twitch.lab.dtest$isTarget)
eva.twitch.res.lab.rf <- confMatrixes.res.lab.rf$byClass
eva.twitch.res.lab.rf
confMatrixes.res.lab.rf$overall

print("res")
predictions.res.res.rf = predict(twitch.res.classifier_RF, newdata = twitch.res.dtest)
confMatrixes.res.res.rf <- confusionMatrix(predictions.res.res.rf, twitch.res.dtest$isTarget)
eva.twitch.res.res.rf <- confMatrixes.res.res.rf$byClass
eva.twitch.res.res.rf
...
## Models - LASSO - Lab - twitch
```{r}
#perform k-fold cross-validation to find optimal lambda value
lambdas_to_try <- 10^seq(-3, 5, length.out = 100)
x.lab = as.matrix(twitch.lab.dtrain[-73])

cv_model.lab <- cv.glmnet(x.lab, twitch.lab.dtrain$isTarget, alpha = 1,
...
cv_best_model.lab <- glmnet(x.lab, twitch.lab.dtrain$isTarget, alpha = 1,
...
## Models - LASSO - Res - twitch
```{r}
#perform k-fold cross-validation to find optimal lambda value
lambdas_to_try <- 10^seq(-3, 5, length.out = 100)
x.res = as.matrix(twitch.res.dtrain[-73])

cv_model.res <- cv.glmnet(x.res, twitch.res.dtrain$isTarget, alpha = 1,
                      lambda = lambdas_to_try,
                      standardize = TRUE,
                      nfolds = 10,
                      family = "binomial")
...
cv_best_model.res <- glmnet(x.res, twitch.res.dtrain$isTarget, alpha = 1,
                      lambda = best_lambda.lab,
                      standardize = TRUE,
                      family = "binomial")
...
```{r}
dtest.lab <- as.matrix(twitch.lab.dtest[-73])
ncol(dtest.lab)
dtest.res <- as.matrix(twitch.res.dtest[-73])
threshold <- 0.5
...
confmtx.lab.lab.lasso <- confusionMatrix(table(predicted_classes.lab.lab,twitch.lab.dtest$isTarget))
confmtx.lab.res.lasso <- confusionMatrix(table(predicted_classes.lab.res,twitch.res.dtest$isTarget))
...
confmtx.res.lab.lasso <- confusionMatrix(table(predicted_classes.res.lab,twitch.lab.dtest$isTarget))
confmtx.res.res.lasso <- confusionMatrix(table(predicted_classes.res.res,twitch.res.dtest$isTarget))
