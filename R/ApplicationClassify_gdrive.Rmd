...
```{r}
drops <- process_data_lab("gdrive.lab")
gdrive.lab.dtrain
gdrive.lab.dtest

process_data_res("gdrive.res")
gdrive.res.dtrain
gdrive.res.dtest
```
...
gdrive.lab.C45Model <- train(isTarget ~., method="J48", data=gdrive.lab.dtrain,
                tuneLength = 5,
                trControl = train_control)

gdrive.res.C45Model <- train(isTarget ~., method="J48", data=gdrive.res.dtrain,
                tuneLength = 5,
                trControl = train_control)
```

## Validation - gdrive - C45 - Lab
...
confMatrixes.lab.lab <- confusionMatrix(predictions.lab.lab, gdrive.lab.dtest$isTarget)
eva.gdrive.c45.lab.lab <- confMatrixes.lab.lab$byClass
eva.gdrive.c45.lab.lab
confMatrixes.lab.lab$overall

print("res")
predictions.lab.res = predict(gdrive.lab.C45Model, newdata = gdrive.res.dtest)
confMatrixes.lab.res <- confusionMatrix(predictions.lab.res, gdrive.res.dtest$isTarget)
eva.gdrive.c45.lab.res <- confMatrixes.lab.res$byClass
eva.gdrive.c45.lab.res
confMatrixes.lab.res$overall
```

## Validation - gdrive - C45 - res

```{r}
gdrive.res.C45Model$finalModel

print("lab")
predictions.res.lab = predict(gdrive.res.C45Model, newdata = gdrive.lab.dtest)
confMatrixes.res.lab <- confusionMatrix(predictions.res.lab, gdrive.lab.dtest$isTarget)
...
confMatrixes.res.res <- confusionMatrix(predictions.res.res, gdrive.res.dtest$isTarget)
...
gdrive.lab.classifier_RF = randomForest(x = gdrive.lab.dtrain[-77],
                             y = gdrive.lab.dtrain$isTarget,
                             ntree = 500,
                             trControl = repeat_cv)

gdrive.res.classifier_RF = randomForest(x = gdrive.res.dtrain[-77],
                             y = gdrive.res.dtrain$isTarget,
                             ntree = 500,
                             trControl = repeat_cv)
...
confMatrixes.lab.lab.rf <- confusionMatrix(predictions.lab.lab.rf, gdrive.lab.dtest$isTarget)
eva.gdrive.lab.lab.rf <- confMatrixes.lab.lab.rf$byClass
eva.gdrive.lab.lab.rf
confMatrixes.lab.lab.rf$overall

print("res")
predictions.lab.res.rf = predict(gdrive.lab.classifier_RF, newdata = gdrive.res.dtest)
confMatrixes.lab.res.rf <- confusionMatrix(predictions.lab.res.rf, gdrive.res.dtest$isTarget)
eva.gdrive.lab.res.rf <- confMatrixes.lab.res.rf$byClass
eva.gdrive.lab.res.rf
...
```{r}
print("lab")
predictions.res.lab.rf = predict(gdrive.res.classifier_RF, newdata = gdrive.lab.dtest)
confMatrixes.res.lab.rf <- confusionMatrix(predictions.res.lab.rf, gdrive.lab.dtest$isTarget)
eva.gdrive.res.lab.rf <- confMatrixes.res.lab.rf$byClass
eva.gdrive.res.lab.rf
confMatrixes.res.lab.rf$overall

print("res")
predictions.res.res.rf = predict(gdrive.res.classifier_RF, newdata = gdrive.res.dtest)
confMatrixes.res.res.rf <- confusionMatrix(predictions.res.res.rf, gdrive.res.dtest$isTarget)
eva.gdrive.res.res.rf <- confMatrixes.res.res.rf$byClass
eva.gdrive.res.res.rf
...
## Models - LASSO - Lab - gdrive

```{r}
#perform k-fold cross-validation to find optimal lambda value
lambdas_to_try <- 10^seq(-3, 5, length.out = 100)
x.lab = as.matrix(gdrive.lab.dtrain[-76])

cv_model.lab <- cv.glmnet(x.lab, gdrive.lab.dtrain$isTarget, alpha = 1,
...
cv_best_model.lab <- glmnet(x.lab, gdrive.lab.dtrain$isTarget, alpha = 1,
...
## Models - LASSO - Res - gdrive

```{r}
#perform k-fold cross-validation to find optimal lambda value
lambdas_to_try <- 10^seq(-3, 5, length.out = 100)
x.res = as.matrix(gdrive.res.dtrain[-76])

cv_model.res <- cv.glmnet(x.res, gdrive.res.dtrain$isTarget, alpha = 1,
                      lambda = lambdas_to_try,
                      standardize = TRUE,
                      nfolds = 10,
                      family = "binomial")
...
cv_best_model.res <- glmnet(x.res, gdrive.res.dtrain$isTarget, alpha = 1,
                      lambda = best_lambda.lab,
                      standardize = TRUE,
                      family = "binomial")
...
```{r}
dtest.lab <- as.matrix(gdrive.lab.dtest[-76])
ncol(dtest.lab)
dtest.res <- as.matrix(gdrive.res.dtest[-76])
threshold <- 0.5
...
confmtx.lab.lab.lasso <- confusionMatrix(table(predicted_classes.lab.lab,gdrive.lab.dtest$isTarget))
confmtx.lab.res.lasso <- confusionMatrix(table(predicted_classes.lab.res,gdrive.res.dtest$isTarget))
...
confmtx.res.lab.lasso <- confusionMatrix(table(predicted_classes.res.lab,gdrive.lab.dtest$isTarget))
confmtx.res.res.lasso <- confusionMatrix(table(predicted_classes.res.res,gdrive.res.dtest$isTarget))
