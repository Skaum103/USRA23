...
## Data files
```{r}
slack.lab.1.noVPN = read.csv("slackPcapFixGapLab1_flows.csv")
slack.lab.1.1111 = read.csv("slackPcapFixGapLab1_1111_flows.csv")
...
## Load more files
```{r}
slack.lab.3.noVPN = read.csv("slackPcapFixGapLab3_flows.csv")
slack.lab.3.1111 = read.csv("slackPcapFixGapLab3_1111_flows.csv")
