...
predictions.slack.lab.lab <- predict(cv_best_model, s = best_lambda, x, type = "response")
predictions.slack.lab.res <- predict(cv_best_model, s = best_lambda, x.res, type = "response")
threshold <- 0.5
...
#confusion.glmnet(predictions.slack.lab.lab,newx=x,newy=slack.lab.data$isVPN)
#confusion.glmnet(predictions.slack.lab.res,newx=x.res,newy=slack.res.data$isVPN)
```