...
slack.lab.classifier_RF
slack.res.classifier_RF
...
x = as.matrix(slack.lab.data[-81])

slack.lab.data <- slack.lab.data[, !(names(slack.lab.1.1111) %in% c("X.dir", "ipOptCpCl_Num"))]

s <- slack.lab.data %>% select_if(negate(is.numeric))
s <- select_if(slack.lab.data, is.character
s
