...
slack.lab.prop = nrow(slack.lab.1111)*0.7 / nrow(slack.lab.noVPN)

slack.lab.noVPN.trnRows  <- sample(nrow(slack.lab.noVPN),nrow(slack.lab.noVPN)*slack.lab.prop)
slack.lab.noVPN.dtrain <- slack.lab.noVPN[ slack.lab.noVPN.trnRows,]
slack.lab.noVPN.dtest  <- slack.lab.noVPN[-slack.lab.noVPN.trnRows,]
...
slack.lab.dtrain <- rbind(slack.lab.noVPN.dtrain,slack.lab.1111.dtrain)
slack.lab.dtest <- rbind(slack.lab.1111.dtest,slack.lab.noVPN.dtest)

slack.lab.dtrain$isVPN <- as.factor(slack.lab.dtrain$isVPN)
slack.lab.dtest$isVPN <- as.factor(slack.lab.dtest$isVPN)
...
```{r}
train_control<- trainControl(method="cv", number=10)
slack.lab.C45Model <- train(isVPN ~., method="J48", data=slack.lab.dtest,
                tuneLength = 5,
                trControl = train_control)
...
predictions = predict(slack.lab.C45Model, newdata = slack.lab.dtest)
confusionMatrix(predictions, slack.lab.dtest$isVPN)
```